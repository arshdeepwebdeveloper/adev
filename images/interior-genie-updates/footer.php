                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">  
                            <div class="widget text-center getin-touch">
                                ...
                                <div class="widget-section">
                                    <ul>
                                        <li><a href="tel:+919780043111">+91 97800-43111</br/></a><a href="tel:+917082071500"> +91 70820-71500</a></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="widget text-center widget_address m-b20">
                                ...
                                <div class="widget-section">
                                    <ul>
                                        <li>SCO- 213, 2nd Floor, Mohali Citi Centre 2, Airport Road</li>
                                    </ul>
                                </div>
                                <div class="footer-social-icon">
                                    <ul class="social-icons f-social-link">
                                        <li><a href="https://www.facebook.com/profile.php?id=61557974979560/" target="_blank" class="fa fa-facebook"></a></li>
                                        <li><a href="https://www.instagram.com/decodreamsinteriors/" target="_blank" class="fa fa-instagram"></a></li>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="widget text-center">
                                <h4 class="widget-title">Gmail</h4>
                                <div class="widget-section">
                                    <ul>
                                        <li><a href="mailto:hellointeriorgenie@gmail.com">hellointeriorgenie@gmail.com</a></li>
                                    </ul>
                                </div>                                
                            </div>                           
                        </div>      
                ...
                <div class="container">
                    <div class="row">
                        <div class="wt-footer-bot-center">
                            <span class="copyright">© 2024 Interior Genie. Designed By <a href="https://pacewalk.com/" target="_blank">Pacewalk</a></span>
                        </div>

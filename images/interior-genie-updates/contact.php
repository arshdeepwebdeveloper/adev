                      ...
                      <div class="row contact-info-section">
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-lr30 p-tb50 bdr-1 bdr-gray">
                                    ...
                                    <div class="icon-content">
                                        <h4>Phone number</h4>
                                        <h5><a href="tel:+919780043111">+91 97800-43111,</a>
                                        </br><a href="tel:+917082071500"> +91 70820-71500</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-lr30 p-tb50  block-shadow">
                                    ...
                                    <div class="icon-content">
                                        <h4>Email address</h4>
                                        <h5><a href="mailto:hellointeriorgenie@gmail.com">hellointeriorgenie@gmail.com</a></h5>
                            ...
                            <div class="col-md-4 col-sm-12 m-b30">
                                <div class="wt-icon-box-wraper center p-lr30 p-tb50">
                                    ...
                                    <div class="icon-content">
                                        <h4>Address info</h4>
                                        <h5>SCO- 213, 2nd Floor, Mohali Citi Centre 2, Airport Road</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="contact-form cons-contact-form" method="post" action="form-handler.php">
                                <div class="contact-one">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <input name="username" type="phone" required class="form-control" placeholder="Phone">
                                                <span class="spin"></span>
                                            </div>
                                        </div>
                                          <div class="col-md-6 col-sm-6">
                                            <div class="form-group">
                                                <input name="username" type="text" required class="form-control" placeholder="subject">
                                                <span class="spin"></span>
                                            </div>
                                        </div>
